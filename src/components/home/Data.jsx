...
import CV from "../../assets/CV_AntonDelaGarza_Español.pdf";

const Data = () => {
  return (
    <div className="home__data">
      <h1 className="home__title">
        Anton De <br /> la Garza
        <svg
          width="36"
          height="36"
          viewBox="0 0 48 48"
      ...
      <h3 className="home__subtitle">Científico de Datos</h3>
      <p className="home__description">
      Soy estudiante de Ciencia de Datos y Matemáticas basado en Monterrey, Nuevo León.<br />
      Me interesa aplicar técnicas de análisis de datos para resolver problemas y generar valor.
      </p>
